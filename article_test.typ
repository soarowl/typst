...
此前曾有媒体报道称，谷歌的普通员工和管理层之间关系紧张。比如，谷歌要求高管为员工表现进行绩效打分@zygos。

希克森建议，应该努力将权力从首席财务官办公室转移到这样一个人手中@omarova-libra——他应该对如何利用谷歌广泛的资源为用户创造价值有清晰长期的愿景。

至于谷歌的文化是否可以挽救，希克森认为可以，但他称“时间紧迫”。他写道：“谷歌文化的腐化最终将变得不可逆转，因为它需要充当道德指南针的那种人，而这类人在没有道德指南针的情况下不会愿意加入谷歌。”

源代码参见： @lst:fibonaci， 表格： @tbl:lang， 图： @fig:apple。
...
#figure(caption: [苹果], image("images/apple.jpg", width: 90%)) <apple>
